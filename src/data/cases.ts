...
export const cases: Case[] = [
  {
    ...
    img: '/images/cases/01-automotive-assembly.jpg',
    metric: '+40%',
    metricLabel: '效率提升',
    featured: true,
  },
  {
    ...
    img: '/images/cases/02-hydraulic-press.jpg',
    metric: '35-45%',
    metricLabel: '节能率',
    featured: true,
  },
  {
    ...
    img: '/images/cases/03-injection-molding.jpg',
    metric: '15-40%',
    metricLabel: '节能率',
    featured: true,
  },
  {
    ...
    img: '/images/cases/04-food-packaging.jpg',
    metric: '3.2x',
    metricLabel: '产能',
    featured: false,
  },
  {
    ...
    img: '/images/cases/05-material-handling.jpg',
    metric: '8',
    metricLabel: '工位数',
    featured: false,
  },
  {
    ...
    img: '/images/cases/06-machine-tool.jpg',
    metric: '±0.01',
    metricLabel: '精度',
    featured: false,
  },
